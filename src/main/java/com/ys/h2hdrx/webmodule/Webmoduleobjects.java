...
public class Webmoduleobjects extends Driver {
	...
	//}
		...
		@FindBy(how = How.XPATH, using = "//a[contains(text(),'Pending Refills')]")
		public WebElement Pending_Refills;

		@FindBy(how = How.XPATH, using = "//*[@id=\"scrollableTBodyFull\"]/table/tbody/tr[2]/td[1]")
        public WebElement PatientRefillReq;		
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"scrollableTBodyFull\"]/table/tbody/tr[2]/td[2]")
        public WebElement PatientRefillcon;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"scrollableTBodyFull\"]/table/tbody/tr[2]/td[1]/a")
        public WebElement selRefillReq;		
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"formPatientProfileTabs\"]/div/center/table/tbody/tr[2]/td[2]")
		public WebElement RefillDrugDescription;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"RefillAction0\"]")
		public WebElement Refilldrpdwm;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"DenialReason0\"]")
		public WebElement DenialReason;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"dispensibleDrugId\"]")
		public WebElement DDChange;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"sendButton\"]")
		public WebElement RefillSndButton;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"formPatientProfileTabs\"]/div/center/table/tbody/tr[4]/td[8]/a")
		public WebElement Pharmacy_link;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"formPatientProfileTabs\"]/div/center/table/tbody/tr[5]/td[5]/a")
		public WebElement prescribed_drug_info;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"formPatientProfileTabs\"]/div/center/table/tbody/tr[8]/td[5]/a")
		public WebElement delete_link;
		
		/*Pending Refill alerts*/
		
		@FindBy(how = How.XPATH, using = "//a[contains(text(),'Pending Refill Alerts')]")
		public WebElement Pending_Refill_Alerts;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"scrollableTBodyFull\"]/table/tbody/tr[2]/td[1]")
        public WebElement RefillAlertchk;	
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"scrollableTBodyFull\"]/table/tbody/tr[2]/td[3]")
        public WebElement Alert_Patient_name;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"scrollableTBodyFull\"]/table/tbody/tr[2]/td[4]")
        public WebElement AlertDrugname;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"scrollableTBodyFull\"]/table/tbody/tr[2]/td[5]")
        public WebElement AlertDescription;
		
		@FindBy(how = How.XPATH, using = "//a[contains(text(),'View Alert')]")
		public WebElement ViewAlert;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"mainDiv\"]/div[4]/div/span")
		public WebElement RefillSchType;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"buttons\"]/table/tbody/tr/td[2]/span[1]/a")
        public WebElement Alert_backBtn;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"buttons\"]/table/tbody/tr/td[2]/span[2]/a")
        public WebElement Alert_ApprovedBtn;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"buttons\"]/table/tbody/tr/td[2]/span[3]/a")
        public WebElement Alert_DeniedBtn;
		
		@FindBy(how = How.XPATH, using ="//*[@id=\"reasonDenied\"]")
		public WebElement Alert_DeniedReason;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"buttons\"]/table/tbody/tr/td[2]/span[4]/a")
        public WebElement AlertReplaceBtn;
		
		@FindBy(how = How.XPATH, using = "//*[@id=\"mainDiv\"]/div[4]/div/a")
        public WebElement prescribed_info;
